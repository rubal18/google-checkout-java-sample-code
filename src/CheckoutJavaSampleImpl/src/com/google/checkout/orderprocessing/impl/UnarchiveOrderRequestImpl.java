...
public class UnarchiveOrderRequestImpl extends AbstractCheckoutRequest
    implements UnarchiveOrderRequest {
   ...
   * (non-Javadoc)
   * 
   * @see com.google.checkout.orderprocessing.UnarchiveOrderRequest#getGoogleOrderNo()
   */
   ...
   * (non-Javadoc)
   * 
   * @see com.google.checkout.orderprocessing.UnarchiveOrderRequest#setGoogleOrderNo(java.lang.String)
   */
