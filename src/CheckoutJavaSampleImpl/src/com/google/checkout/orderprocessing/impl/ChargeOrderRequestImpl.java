...
public class ChargeOrderRequestImpl extends AbstractCheckoutRequest
   ...
   * Number and the ammount to be charged.
   * 
   * @param merchantConstants
   *          The MerchantConstants.
   * @param googleOrderNumber
   ...
   * (non-Javadoc)
   * 
   * @see com.google.checkout.orderprocessing.ChargeOrderRequest#getAmount()
   */
   ...
   * (non-Javadoc)
   * 
   * @see com.google.checkout.orderprocessing.ChargeOrderRequest#getGoogleOrderNo()
   */
   ...
   * (non-Javadoc)
   * 
   * @see com.google.checkout.orderprocessing.ChargeOrderRequest#setAmount(float)
   */
   ...
   * (non-Javadoc)
   * 
   * @see com.google.checkout.orderprocessing.ChargeOrderRequest#setGoogleOrderNo(java.lang.String)
   */
