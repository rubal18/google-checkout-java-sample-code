...
public class ArchiveOrderRequestImpl extends AbstractCheckoutRequest
   ...
   * (non-Javadoc)
   * 
   * @see com.google.checkout.orderprocessing.ArchiveOrderRequest#getGoogleOrderNo()
   */
   ...
   * (non-Javadoc)
   * 
   * @see com.google.checkout.orderprocessing.ArchiveOrderRequest#setGoogleOrderNo(java.lang.String)
   */
