...
public final class AuthorizeOrderRequestImpl extends AbstractCheckoutRequest implements AuthorizeOrderRequest {
	Document document;
	Element root;
	...
	public AuthorizeOrderRequestImpl(MerchantConstants merchantConstants) {
	    ...
	    root = (Element) document.createElementNS(Constants.checkoutNamespace, "authorize-order"); 
	    root.setAttributeNS("http://www.w3.org/2000/xmlns/","xmlns", Constants.checkoutNamespace);
	    document.appendChild(root);
	}	
	
	public AuthorizeOrderRequestImpl(MerchantConstants merchantConstants, String googleOrderNo) {
