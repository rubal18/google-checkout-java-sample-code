package com.google.checkout.webappexample.util;
...
public class GoogleOrder implements Serializable {
	...
	public static GoogleOrder findOrCreate(String merchantId, String orderNumber) throws Exception {
	...
	public synchronized void addIncomingMessage(Date timestamp, String type, String request, String response) throws Exception {
	...
	public synchronized void addOutgoingMessage(Date timestamp, String type, String request, String response) throws Exception {
	...
	private void save() throws Exception {
        ...
        ObjectOutput out = new ObjectOutputStream(new FileOutputStream(new File(dir, "GCO_"+merchantId+"_"+orderNumber+".ser")));
