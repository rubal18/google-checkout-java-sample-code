 ...
 * @author simonjsmith
 */
public class CheckoutShoppingCartRequestImpl extends AbstractCheckoutRequest
    implements CheckoutShoppingCartRequest {
  ...
  public CheckoutShoppingCartRequestImpl(MerchantConstants merchantConstants) {
    ...
    root = (Element) document.createElementNS(
        "http://checkout.google.com/schema/2", "checkout-shopping-cart");
   ...
   *      float, com.google.checkout.checkout.ShippingRestrictions)
   */
  public void addFlatRateShippingMethod(String name, float cost,
    ...
    Element price = Utils.createNewElementAndSet(document, newShip, "price",
        cost);
   ...
   * (non-Javadoc)
   * 
   * @see com.google.checkout.checkout.CheckoutShoppingCartRequest#addItem(java.lang.String,
   *      java.lang.String, float, int)
   */
   ...
   * 
   * @see com.google.checkout.checkout.CheckoutShoppingCartRequest#addItem(java.lang.String,
   *      java.lang.String, float, int, java.lang.String)
   */
   ...
   * 
   * @see com.google.checkout.checkout.CheckoutShoppingCartRequest#addItem(java.lang.String,
   *      java.lang.String, float, int, org.w3c.dom.Element[])
   */
  public void addItem(String name, String description, float price,
  ...
  public void addItem(String name, String description, float price,
    ...
    Utils.createNewElementAndSet(document, item, "item-description",
        description);
    Element ePrice = Utils.createNewElementAndSet(document, item, "unit-price",
        price);
   ...
   * (non-Javadoc)
   * 
   * @see com.google.checkout.checkout.CheckoutShoppingCartRequest#addMerchantCalculatedShippingMethod(java.lang.String,
   *      float)
   */
   ...
   * (non-Javadoc)
   * 
   * @see com.google.checkout.checkout.CheckoutShoppingCartRequest#addPickupShippingMethod(java.lang.String,
   *      float)
   */
  ...
  public String getAnalyticsData() {
    ...
    Element mcfs = Utils.findElementOrContainer(document, checkoutFlowSupport,
        "merchant-checkout-flow-support");
    if (mcfs == null) {
      return "";
    }
  ...
  public Date getCartExpiration() {
    ...
    Element expiration = Utils.findElementOrContainer(document, shoppingCart,
        "cart-expiration");
    if (expiration == null) {
      return null;
    }
  ...
  public void setCartExpiration(Date date) {
    ...
    Element expiration = Utils.findContainerElseCreate(document, shoppingCart,
        "cart-expiration");
   ...
   * (non-Javadoc)
   * 
   * @see com.google.checkout.checkout.CheckoutShoppingCartRequest#addAlternateTaxRule(java.lang.String,
   *      boolean, double, com.google.checkout.checkout.TaxArea)
   */
   ...
   * (non-Javadoc)
   * 
   * @see com.google.checkout.checkout.CheckoutShoppingCartRequest#addDefaultTaxRule(double,
   *      boolean, com.google.checkout.checkout.TaxArea)
   */
